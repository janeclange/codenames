...
class Glove(object):
	...
	def get_weighted_nn(self, word, n=500):
		"""Gets the n nearest neighbors of a word, weighted by their similarity to the word"""
	...
	def rescale_score(self, chosen_words, potential_clue, red_words):
		""" Penalizes a potential_clue for being have high glove similarity with opponent's words
